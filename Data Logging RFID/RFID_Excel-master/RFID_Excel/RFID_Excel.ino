...
void setup() {
  ...
  Serial.println("LABEL,Date,Time,content,Number");// make four columns (Date,Time,[Name:"user name"]line 48 & 52,[Number:"user number"]line 49 & 53)
...
void loop() {
 ...
 if ( ! mfrc522.PICC_ReadCardSerial()) {
  ...
  content.toUpperCase();
      ...
      n++;//(optional)
      Serial.print("DATA,DATE,TIME," +content);//send the Name to excel
      Serial.print(",");
